...
import static net.gotev.xmppservice.XmppServiceBroadcastEventEmitter.BROADCAST_CONNECTED;
import static net.gotev.xmppservice.XmppServiceBroadcastEventEmitter.BROADCAST_CONTACT_ADDED;
import static net.gotev.xmppservice.XmppServiceBroadcastEventEmitter.BROADCAST_CONTACT_ADD_ERROR;
import static net.gotev.xmppservice.XmppServiceBroadcastEventEmitter.BROADCAST_CONTACT_REMOVED;
import static net.gotev.xmppservice.XmppServiceBroadcastEventEmitter.BROADCAST_CONTACT_RENAMED;
import static net.gotev.xmppservice.XmppServiceBroadcastEventEmitter.BROADCAST_CONVERSATIONS_CLEARED;
import static net.gotev.xmppservice.XmppServiceBroadcastEventEmitter.BROADCAST_CONVERSATIONS_CLEAR_ERROR;
import static net.gotev.xmppservice.XmppServiceBroadcastEventEmitter.BROADCAST_DISCONNECTED;
import static net.gotev.xmppservice.XmppServiceBroadcastEventEmitter.BROADCAST_MESSAGE_ADDED;
import static net.gotev.xmppservice.XmppServiceBroadcastEventEmitter.BROADCAST_MESSAGE_DELETED;
import static net.gotev.xmppservice.XmppServiceBroadcastEventEmitter.BROADCAST_MESSAGE_SENT;
import static net.gotev.xmppservice.XmppServiceBroadcastEventEmitter.BROADCAST_ROSTER_CHANGED;
import static net.gotev.xmppservice.XmppServiceBroadcastEventEmitter.PARAM_ALIAS;
import static net.gotev.xmppservice.XmppServiceBroadcastEventEmitter.PARAM_INCOMING;
import static net.gotev.xmppservice.XmppServiceBroadcastEventEmitter.PARAM_MESSAGE_ID;
import static net.gotev.xmppservice.XmppServiceBroadcastEventEmitter.PARAM_REMOTE_ACCOUNT;
